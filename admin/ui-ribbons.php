                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card-box ribbon-box">
                                    <div class="ribbon ribbon-info float-right">Info Ribbon</div>
                                    <div class="ribbon-content">
                                        <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse convallis dignissim eros at volutpat. In egestas mattis dui. Aliquam mattis dictum aliquet. Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio.</p>
                                    </div>
                                </div> <!-- end card-box-->
                            ...
                            <div class="col-lg-4">
                                <div class="card-box ribbon-box">
                                    <div class="ribbon ribbon-warning float-right">Warning Ribbon</div>
                                    <div class="ribbon-content">
                                        <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse convallis dignissim eros at volutpat. In egestas mattis dui. Aliquam mattis dictum aliquet. Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio.</p>
                                    </div>
                                </div> <!-- end card-box-->
                            ...
                            <div class="col-lg-4">
                                <div class="card-box ribbon-box">
                                    <div class="ribbon ribbon-danger float-right">Danger Ribbon</div>
                                    <div class="ribbon-content">
                                        <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse convallis dignissim eros at volutpat. In egestas mattis dui. Aliquam mattis dictum aliquet. Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio.</p>
                                    </div>
                                </div> <!-- end card-box-->
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card-box ribbon-box">
                                    ...
                                    <h5 class="text-primary mt-0 mb-3">Primary Header</h5>
                            ...
                            <div class="col-lg-4">
                                <div class="card-box ribbon-box">
                                    <div class="ribbon-icon"><i class="mdi mdi-seal text-pink display-4 mr-1"></i></div>
                                    <h5 class="text-pink mt-0 mb-3">Pink Header</h5>
                                    <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse convallis dignissim eros at volutpat. In egestas
                                        mattis dui. Aliquam mattis dictum aliquet. Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio.</p>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card-box ribbon-box">
                                    <div class="ribbon-icon"><i class="mdi mdi-seal text-purple display-4 mr-1"></i></div>
                                    <h5 class="text-purple mt-0 mb-3">Purple Header</h5>
                                    <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse convallis dignissim eros at volutpat. In egestas
                                        mattis dui. Aliquam mattis dictum aliquet. Nulla sapien mauris, eleifend et sem ac, commodo dapibus odio.</p>
                                </div>
                            </div>
